...
namespace TestStudentController
{
    ...
    public class StudentController : ApiController
    {
        ...
        [HttpGet]
        [Route("api/student")]
        public async Task<HttpResponseMessage> Get([FromUri]StudentFilterParams filterParams, StudentSortParams sortParams)
        {
            
            List<IStudent> studentList = await Service.GetAllStudents(filterParams, sortParams);
